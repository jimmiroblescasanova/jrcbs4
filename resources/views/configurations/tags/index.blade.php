...
<div class="card">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="#" onclick="editTag('{{ $tag->id }}', '{{ $tag->name }}', '{{ $tag->color }}')"
                            class="mr-2"><i class="fas fa-edit"></i></a>
                        <a href="#" onclick="deleteTag('{{ $tag->id }}', '{{ $row+1 }}')"><i class="fas fa-trash-alt"
                                style="color:red;"></i></a>
                    </td>
                    @endcan
                </tr>
    ...
    <div class="card-footer clearfix">
        <button data-toggle="modal" data-target="#createTagsModal" type="button"
            class="btn btn-primary btn-sm float-right"><i class="fas fa-pencil-alt mr-2"></i>Nuevo</button>
    </div>
    @endcan
</div>
@can('create tags')
