        ...
        <fieldset class="border p-2" id="tickets">
            ...
            <div class="form-check">
                <label class="form-check-label">
                    <input
                    type="checkbox"
                    class="form-check-input tickets"
                    name="permissions[]"
                    value="show tickets"
        ...
        <fieldset class="border p-2" id="activities">
            ...
            <div class="form-check">
                <label class="form-check-label">
                    <input
                    type="checkbox"
                    class="form-check-input activities"
                    name="permissions[]"
                    value="show activities"
                    {{ ($role->hasPermissionTo('show activities')) ? 'checked' : '' }}>
                    Ver actividades
                </label>
            </div>
            <div class="form-check">
                <label class="form-check-label">
                    ...
                    {{ ($role->hasPermissionTo('create activities')) ? 'checked' : '' }}>
                    Crear actividades
                </label>
            </div>
            <div class="form-check">
                <label class="form-check-label">
                    ...
                    {{ ($role->hasPermissionTo('edit activities')) ? 'checked' : '' }}>
                    Editar actividades
                </label>
            </div>
        </fieldset>
